...
document.getElementById("swapButton").addEventListener("click", swapOptions);
...
function swapOptions() {
  ...
  // Update the select elements to reflect the swapped values
  const firOptElement = document.getElementById("firOpt");
  const secOptElement = document.getElementById("secOpt");

  firOptElement.value = firOpt;
  secOptElement.value = secOpt;

  // Update the placeholder and labels
  document.getElementById("heightInput").placeholder =
    "Enter " + firOpt + "...";
  document.getElementById("heightName").innerHTML = firOpt + ":";
  document.getElementById("convertedHeightName").innerHTML = secOpt + ":";
